...
//internal execute server rpc function
...
//new client with channel size
func NewClient(chanSize int) *Client {
	c := new(Client)
	c.chanSyncRet = make(chan *RetInfo, 1)
	c.ChanAsynRet = make(chan *RetInfo, chanSize)
	return c
}
